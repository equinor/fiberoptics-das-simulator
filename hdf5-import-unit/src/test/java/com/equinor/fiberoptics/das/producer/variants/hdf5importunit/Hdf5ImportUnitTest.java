...
@ActiveProfiles("test")
@SpringBootTest(classes= Hdf5Import.class)
public class Hdf5ImportUnitTest {

  private static final Logger logger = LoggerFactory.getLogger(Hdf5ImportUnitTest.class);
  private final static long millisInNano = 1_000_000;

  @Autowired
  Hdf5Import hdf5ImportUnit;

  @Test
  public void testStreamFromHdf5Import() {
