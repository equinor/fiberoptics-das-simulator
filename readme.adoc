...
image::https://github.com/equinor/jsv-avro-rnd/workflows/CI%20Release/badge.svg[]
...
----
{
  ...
  "DasInstrumentBoxUUID": "25be8bc6-cd35-4c9f-9f8d-cabe43326163",
...
|DAS_PRODUCER_KAFKA_CONFIG_LINGER_MS|5| http://kafka.apache.org/documentation.html#producerconfigs
...
docker-compose -f ./dependson-services/compose-kafka.yml up
source ./defaults.env
